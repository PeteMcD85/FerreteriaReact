...
respond_to do |format|
  ...
  format.json { render json: {
    actives:{
      ...
      All: @items.remove_category("PVC").remove_category("Tornillos").remove_category("Tinte").get_actives,
    ...
    inactives:{
      ...
      All: @items.remove_category("PVC").remove_category("Tornillos").remove_category("Tinte").get_inactives,
...
>>>>>>> d8c6cb915fb5a15adabaf4479f65ce6c94dcf8c8
